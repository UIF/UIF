<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EducationProgramSectionMaintenance.aspx.cs" Inherits="UIF.PerformingArts.EducationProgramSectionMaintenance" %>
...
<body bgcolor="Orange" >
    ...
    <asp:Label ID="lblMainpage" runat="server" Font-Size="22pt" 
        ...
        Text="Education Program Section Maintenance"></asp:Label>
