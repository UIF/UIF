...
{
    public partial class VolunteerAttendanceHistory : System.Web.UI.Page
    {
...
//                ddlStudents.Items.Clear();
        ...
        protected void cmbReport_Click(object sender, EventArgs e)
        {
            ...
            if (ddlProgram.Text == "MS Basketball League")
            {
                try
                {
                    ...
                    SqlCommand objCmd = new System.Data.SqlClient.SqlCommand("volunteervolunteerpivotsolutionmsbasketballleague", con3);
            ...
            else if (ddlProgram.Text == "HS Basketball League")
            {
                try
                {
                    ...
                    SqlCommand objCmd = new System.Data.SqlClient.SqlCommand("volunteervolunteerpivotsolutionhsbasketballleague", con3);
                    objCmd.CommandType = System.Data.CommandType.StoredProcedure;
                    gvReport.DataSource = objCmd.ExecuteReader();
                    gvReport.DataBind();
            ...
            else if (ddlProgram.Text == "BasketballTEAMS")
            {
                try
                {
                    ...
                    SqlCommand objCmd = new System.Data.SqlClient.SqlCommand("volunteervolunteerpivotsolutionbasketballTEAMS", con3);
                    objCmd.CommandType = System.Data.CommandType.StoredProcedure;
                    gvReport.DataSource = objCmd.ExecuteReader();
                    gvReport.DataBind();
            ...
            else if (ddlProgram.Text == "3on3 Basketball")
            {
                try
                {
                    ...
                    SqlCommand objCmd = new System.Data.SqlClient.SqlCommand("volunteerpivotsolution3on3basketball", con3);
                    objCmd.CommandType = System.Data.CommandType.StoredProcedure;
                    gvReport.DataSource = objCmd.ExecuteReader();
                    gvReport.DataBind();
            ...
            try
            {
                ...
                if (SectionName == "")
                {
                    ...
                    reload_sql = "insert into volunteerpivotdata "
                                + "select spa.LastName,spa.FirstName, spa.Section, si.CellPhone, si.HomePhone, si.EmergencyContact, si.EmergencyRelationship, si.EmergencyContactPhone, si.HealthConditions, spa.DAY, spa.Attended  "
                                + "from VolunteerProgramAttendance spa "
                                ...
                                + "GROUP BY spa.LastName,spa.FirstName, spa.Section, si.CellPhone, si.HomePhone, si.EmergencyContact, si.EmergencyRelationship, si.EmergencyContactPhone, si.HealthConditions, spa.DAY, spa.Attended  "
        ...
        {
            Response.Clear();
            Response.Redirect("VolunteerAttendanceHistory.aspx?Security=Good&lastname=" + Request.QueryString["lastname"] + "&firstname=" + Request.QueryString["firstname"] + "&StudentLastName=&StudentFirstName=" + "&Dept=" + Request.QueryString["Dept"]);
        }
    }
}