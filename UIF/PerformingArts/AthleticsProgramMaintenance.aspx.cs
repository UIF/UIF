...
{
    public partial class AthleticsProgramMaintenance : System.Web.UI.Page
    {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["security"] == "Good")
                {
                    if (Department == "Athletics")
                    {
                        ...
                        //ddlProgramSeasonHistory.Items.Add("Current Season");
                        //ddlProgramSeasonHistory.Text = "Current Season";
...
//            cmbNewEnrollment2.Enabled = false;
            ...
            try
            {
                ...
                if (ProgramSeason == "")
                {
                    ...
                    reload_sql = "insert into pivotdata "
                                + "select sie.StudentLastName,sie.StudentFirstName, sie.SectionName, spa.DAY, spa.Attended, si.CurrentRegistrationForm, si.Grade, si.ParentalConsentForm, sie.Contract, sie.Paid, sie.TeamColor, sie.GotPicture,sie.Comments, si.HomePhone "
                                + "from " + ProgramTable + " sie "
                                + "LEFT OUTER JOIN StudentProgramAttendance spa "
                                ...
                                + "WHERE sie.student = 1 "
                                + "GROUP BY sie.StudentLastName,sie.StudentFirstName, sie.SectionName,spa.DAY, spa.Attended, si.CurrentRegistrationForm, si.Grade, si.ParentalConsentForm, sie.Contract, sie.Paid, sie.TeamColor, sie.GotPicture,sie.Comments, si.HomePhone "
                ...
                else
                {
                    ...
                    reload_sql = "insert into pivotdata "
                                ...
                                + "from " + ProgramTable + " sie "
                                + "LEFT OUTER JOIN StudentProgramAttendance spa "
                                + "ON (sie.studentlastname = spa.lastname AND sie.studentfirstname = spa.firstname AND spa.Program = '" + Program + "') "
                                + "LEFT OUTER JOIN StudentInformation si "
                                + "ON (spa.LastName = si.LastName AND spa.FirstName = si.FirstName AND spa.MiddleName = si.MiddleName) "
                                //+ "ON (spa.LastName = si.LastName AND spa.FirstName = si.FirstName) "
                                + "WHERE sie.student = 1 "
                                + "AND spa.ProgramSeason = '" + ProgramSeason + "' "
                                + "AND sie.SectionName = '" + SectionName + "' "
                                + "GROUP BY sie.StudentLastName,sie.StudentFirstName, sie.SectionName,spa.DAY, spa.Attended, si.CurrentRegistrationForm, si.Grade, si.ParentalConsentForm, sie.Contract, sie.Paid, sie.TeamColor, sie.GotPicture,sie.Comments, si.HomePhone "
                                + "ORDER BY sie.StudentLastName, sie.StudentFirstName ";
                }
                con.Open();
        ...
        protected void ReloadPivotDataTable(string ProgramTable, string Program, string ProgramSeason)
        {
            ...
            try
            {
                if (ProgramSeason == "")
                {
                    //By Program 
                    reload_sql = "insert into pivotdata "
                                + "select sie.StudentLastName,sie.StudentFirstName, sie.SectionName, spa.DAY, spa.Attended, si.CurrentRegistrationForm, si.Grade, si.ParentalConsentForm, sie.Contract, sie.Paid, sie.TeamColor, sie.GotPicture, si.HealthConditions, si.HomePhone "
                                + "from " + ProgramTable + " sie "
                                + "LEFT OUTER JOIN StudentProgramAttendance spa "
                                + "ON (sie.studentlastname = spa.lastname AND sie.studentfirstname = spa.firstname AND Program = '" + Program + "') "
                                + "LEFT OUTER JOIN StudentInformation si "
                                ...
                                //+ "ON (spa.LastName = si.LastName AND spa.FirstName = si.FirstName) "
                                + "WHERE sie.student = 1 "
                                + "GROUP BY sie.StudentLastName,sie.StudentFirstName, sie.SectionName,spa.DAY, spa.Attended, si.CurrentRegistrationForm, si.Grade, si.ParentalConsentForm, sie.Contract, sie.Paid, sie.TeamColor, sie.GotPicture, si.HomePhone, si.HealthConditions "
                                + "ORDER BY sie.StudentLastName, sie.StudentFirstName ";
                }
                else
                {
        ...
        protected void ddlProgram_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            PopulateProgramSeason(ddlProgram.Text, ddlProgramSection.Text, ddlTeamSections.Text);

            //UpdateInformation();
        }


        protected void PopulateProgramSeason(string Program, string ProgramSection, string ProgramTeamName)
        {
            string sql = "";
            if (ddlProgram.Text == "Please select a program")
            {
        ...
        protected void cmbRetreiveProgram_Click(object sender, EventArgs e)
        {
            ...
            //    }
            //    custDS.Clear();
            //    ddlStudents.Text = "Please select a student";
            //    //lblProgramSections.Visible = true;
            //    //ddlProgramSection.Visible = true;
            //    //ddlProgramSection.Enabled = true;
        ...
        {
            Response.Clear();
            Response.Redirect("AthleticsProgramMaintenance.aspx?Security=Good&lastname=" + Request.QueryString["lastname"] + "&firstname=" + Request.QueryString["firstname"] + "&StudentLastName=&StudentFirstName=" + "&Dept=" + Request.QueryString["Dept"]);
        }
        ...
        protected void ddlStudents_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ddlProgram.Text == "MS Basketball League")
            {
                sql_LoadGrid = "Select bte.studentlastname, bte.studentfirstname, si.currentregistrationform, si.parentalconsentform, bte.contract, bte.paid, bte.coachteam, bte.gotpicture, si.pictureidentification, bte.comments, bte.middlename, bte.lastupdatedby, bte.sysupdate, si.notes, bte.teamcolor   "
                             + "from UIF_PerformingArts.dbo.MSBasketballLeagueEnrollment bte "
                             + "LEFT OUTER JOIN UIF_PerformingArts.dbo.StudentInformation si "
                    //+ "ON (bte.studentlastname = si.lastname AND bte.studentfirstname = si.firstname) "
                             + "ON (bte.studentlastname = si.lastname AND bte.studentfirstname = si.firstname AND bte.middlename = si.middlename) "
                             + "WHERE bte.sectionname = '" + ddlProgramSection.Text + "' "
                             + "AND bte.studentlastname = '" + ddlStudents.SelectedValue.Substring(0, ddlStudents.SelectedValue.IndexOf(",")) + "' "
                    //+ "AND bte.studentfirstname = '" + ddlStudents.SelectedValue.Substring(ddlStudents.SelectedValue.IndexOf(",") + 1, ddlStudents.SelectedValue.Length - (ddlStudents.SelectedValue.IndexOf(",") + 1)) + "' "
                             + "AND bte.studentfirstname = '" + ddlStudents.SelectedValue.Substring(ddlStudents.SelectedValue.IndexOf(",") + 1, ((ddlStudents.SelectedValue.IndexOf("(")) - (ddlStudents.SelectedValue.IndexOf(",") + 2))) + "' "
                             + "AND bte.middlename = '" + ddlStudents.SelectedValue.Substring(ddlStudents.SelectedValue.IndexOf("(") + 1, ((ddlStudents.SelectedValue.IndexOf(")")) - (ddlStudents.SelectedValue.IndexOf("("))) - 1) + "' "
                             + "AND bte.student = 1 "
                             + "AND bte.volunteer = 0 "
                             + "GROUP BY bte.studentlastname, bte.studentfirstname, si.currentregistrationform, si.parentalconsentform, bte.contract, bte.paid, bte.coachteam, bte.gotpicture, si.pictureidentification, bte.comments, bte.middlename, bte.lastupdatedby, bte.sysupdate, si.notes, bte.teamcolor "
                             + "order by bte.studentlastname, bte.studentfirstname ";
            }
            ...
            {	//Retrieve the first record only
                ...
                {
                    lblName.Text = reader.GetString(0) + "," + reader.GetString(1) + " (" + reader.GetString(10) + ") ";
                }
                ...
                {
                    txbCoachTeam.Text = reader.GetString(6);
                }
                ...
                {
                    chbGotPicture.Checked = reader.GetBoolean(7);
                }
                ...
                {
                    imgStudent.ImageUrl = reader.GetString(8);
                }
                ...
                {
                    txbComments.Text = reader.GetString(9);
                }
                ...
                {
                    lblLastUpdatedBy.Text = "LastUpdatedBy: " + reader.GetString(11) + " On: " + reader.GetSqlValue(12).ToString();
                }
                ...
                {
                    txbSPComments.Text = reader.GetString(13);
                }
                ...
                else
                {
                    try
                    {
                        ddlTeamSections.Text = reader.GetString(14);
                        ddlTeamSectionUpdate.Text = reader.GetString(14);
                    }
            ...
            try
            {
                ...
                if (ddlProgram.Text == "BasketballTEAMS")
                {
                    try
                    {
                        ...
                        + "AND studentfirstname = '" + ddlStudents.SelectedValue.Substring(ddlStudents.SelectedValue.IndexOf(",") + 1, ((ddlStudents.SelectedValue.IndexOf("(")) - (ddlStudents.SelectedValue.IndexOf(",") + 2))) + "' "
                        + "AND middlename = '" + ddlStudents.SelectedValue.Substring(ddlStudents.SelectedValue.IndexOf("(") + 1, ((ddlStudents.SelectedValue.IndexOf(")")) - (ddlStudents.SelectedValue.IndexOf("("))) - 1) + "' "
        ...
        protected void cmbCallingListReport_Click(object sender, EventArgs e)
        {
            ...
            if (ddlProgram.Text == "MS Basketball League")
            {
                try
                {
                    ...
                    {
                        sql = "Select bte.Studentlastname as 'LastName', bte.Studentfirstname as 'FirstName', bte.SectionName, bte.CoachTeam, si.HomePhone, si.Address, si.City, si.State, si.Zip, pgi.ParentGuardian1, pgi.ParentGuardianRelationship1 as 'PG1Relation', pgi.CellPhone1 as 'PG1CellPhone', pgi.ParentGuardian2, pgi.ParentGuardian2Relationship as 'PG2Relation', pgi.CellPhone2 as 'PG2CellPhone'"
                        //sql = "Select bte.Studentlastname as 'LastName', bte.Studentfirstname as 'FirstName', bte.SectionName, bte.CoachTeam, si.HomePhone, pgi.ParentGuardian1, pgi.ParentGuardianRelationship1 as 'PG1Relation', pgi.CellPhone1 as 'PG1CellPhone', pgi.ParentGuardian2, pgi.ParentGuardian2Relationship as 'PG2Relation', pgi.CellPhone2 as 'PG2CellPhone'"
                            + "FROM UIF_PerformingArts.dbo.MSBasketballLeagueEnrollment bte "
                            + "LEFT OUTER JOIN UIF_PerformingArts.dbo.StudentInformation si "
                            + "ON (bte.studentlastname = si.lastname AND bte.studentfirstname = si.firstname) "
                            ...
                            + "ON (bte.studentlastname = ckp.lastname AND bte.studentfirstname = ckp.firstname) "
                            + "WHERE bte.student = 1 "
                            + "GROUP BY bte.studentlastname, bte.studentfirstname, bte.sectionname, bte.coachteam, si.homephone, si.Address, si.City, si.State, si.Zip, pgi.ParentGuardian1, pgi.ParentGuardianRelationship1, pgi.CellPhone1, pgi.ParentGuardian2, pgi.ParentGuardian2Relationship, pgi.CellPhone2 "
                            + "ORDER BY bte.studentlastname, bte.studentfirstname ";
                    }
                    else
                    {
            ...
            else if (ddlProgram.Text == "Outreach Basketball")
            {
                try
                {
                    ...
                    SqlDataAdapter da = new SqlDataAdapter(sql, con3);
                    DataSet ds = new DataSet();
                    da.Fill(ds, "OutreachBasketballEnrollment");
                    gvReport.DataSource = ds.Tables[0];
                    gvReport.DataBind();
                    con3.Close();
                    cmbExcelExport.Enabled = true;
            ...
            else if (ddlProgram.Text == "Special Events")
            {
                try
                {
                    ...
                    SqlDataAdapter da = new SqlDataAdapter(sql, con3);
                    DataSet ds = new DataSet();
                    da.Fill(ds, "[SpecialEventsEnrollment]");
                    gvReport.DataSource = ds.Tables[0];
                    gvReport.DataBind();
                    con3.Close();
                    cmbExcelExport.Enabled = true;
        ...
        protected void lbStudentProfileLink_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("RegistrationForm.aspx?Security=Good&lastname=" + Request.QueryString["lastname"] + "&firstname=" + Request.QueryString["firstname"] + "&StudentLastName=" + ddlStudents.SelectedValue.Substring(0, ddlStudents.SelectedValue.IndexOf(","))
                            + "&StudentFirstName=" + ddlStudents.SelectedValue.Substring(ddlStudents.SelectedValue.IndexOf(",") + 1, ((ddlStudents.SelectedValue.IndexOf("(")) - (ddlStudents.SelectedValue.IndexOf(",") + 2))) + "&StudentMiddleName=" + ddlStudents.SelectedValue.Substring(ddlStudents.SelectedValue.IndexOf("(") + 1, ((ddlStudents.SelectedValue.IndexOf(")")) - (ddlStudents.SelectedValue.IndexOf("("))) - 1) + "&Dept=" + Request.QueryString["Dept"]);                
        }
        ...
        protected void ddlTeamSections_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (ddlProgram.Text == "Outreach Basketball")
                {
                    Tablename = "OutreachBasketballEnrollment";
                }
                else if (ddlProgram.Text == "BasketballTEAMS")
                {
                    Tablename = "BasketballTEAMSEnrollment";
                ...
                sql_LoadGrid = "Select tt.studentlastname as 'LastName', tt.studentfirstname as 'FirstName', tt.SectionName, tt.TeamColor, si.Homephone, pgc.Parentguardian1, pgc.Parentguardianrelationship1 as 'PGRelationship1', pgc.ParentGuardian2, pgc.ParentGuardian2relationship as 'PGRelationship2' "
                                + "FROM " + Tablename + " tt "
                                + "LEFT OUTER JOIN Studentinformation si "
                                + "ON (tt.studentlastname = si.lastname AND tt.studentfirstname = si.firstname) "
                                + "LEFT OUTER JOIN ParentGuardianContactInformation pgc "
                                ...
                                + "AND tt.student = 1 "
                                + "GROUP BY tt.studentlastname, tt.studentfirstname, tt.SectionName, tt.Teamcolor, si.Homephone, pgc.Parentguardian1, pgc.parentguardianrelationship1, pgc.parentguardian2, pgc.parentguardian2relationship "
