<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VolunteerAttendance.aspx.cs" Inherits="UIF.PerformingArts.VolunteerAttendance" %>
...
<body bgcolor="Orange">
    ...
    <asp:Label ID="Label1" runat="server" CssClass="style1" Font-Bold="False" 
        Font-Size="23pt" Text="Enter Volunteer Attendance " Font-Italic="True"></asp:Label>
...
order by lastname, firstname" onselecting="SqlDataSource1_Selecting"></asp:SqlDataSource>
            <div style="margin-left: 280px">
                <asp:Button ID="cmbAddAnotherClass" runat="server" Enabled="False" 
                    ...
                    style="z-index: 1; left: 499px; top: 344px; position: absolute; width: 140px" 
    ...
    <asp:Label ID="lblSetAttendance" runat="server" CssClass="style24" 
        ...
        Text="1)  Please set each volunteers attendance accordingly." 
    ...
    <asp:GridView ID="gvStudentList" runat="server" CssClass="style5" 
        ...
        <Columns>
            <asp:BoundField  DataField="StudentLastName" HeaderText="VolunteerLastName" ReadOnly="true"  SortExpression="VolunteerLastName"  />
            <asp:BoundField  DataField="StudentFirstName" HeaderText="VolunteerFirstName" ReadOnly="true"  SortExpression="VolunteerFirstName"  />
            ...
            <asp:TemplateField HeaderText="Hours" >
                <ItemTemplate>
                    <asp:DropDownList id="dropdownlist3"  runat="server"  AutoPostBack="false" BackColor="Orange"
                         >                        
                        <asp:ListItem Text="3.0" Value="3.0"></asp:ListItem>
                        ...
                        <asp:ListItem Text="4.0" Value="4.0"></asp:ListItem>
                        ...
                        <asp:ListItem Text="6.0" Value="6.0"></asp:ListItem>
                        <asp:ListItem Text="6.5" Value="6.5"></asp:ListItem>
                        <asp:ListItem Text="7.0" Value="7.0"></asp:ListItem>
                        <asp:ListItem Text="7.5" Value="7.5"></asp:ListItem>
                        <asp:ListItem Text="8.0" Value="8.0"></asp:ListItem>
                        <asp:ListItem Text="8.5" Value="8.5"></asp:ListItem>
                        <asp:ListItem Text="9.0" Value="9.0"></asp:ListItem>
                        <asp:ListItem Text="9.5" Value="9.5"></asp:ListItem>
                        <asp:ListItem Text="10.0" Value="10.0"></asp:ListItem>
                        <asp:ListItem Text="10.5" Value="10.5"></asp:ListItem>
                        <asp:ListItem Text="11.0" Value="11.0"></asp:ListItem>
                        <asp:ListItem Text="11.5" Value="11.5"></asp:ListItem>
                        <asp:ListItem Text="12.0" Value="12.0"></asp:ListItem>
    ...
    <asp:Label ID="lblInformation" runat="server" CssClass="style10" 
        Enabled="False" Font-Size="Large" Text="Volunteer Names in Program" 
        Visible="False"></asp:Label>
    ...
    <asp:Button ID="cmbCommittAttendance" runat="server" CssClass="style7" 
        onclick="cmbCommittAttendance_Click" Text="Committ the Attendance Data" />
            <asp:Button ID="cmbExcelExport" runat="server" onclick="cmbExcelExport_Click" 
                ...
                Text="Export Volunteer List to Excel" Visible="False" />
    ...
    <asp:DropDownList ID="ddlBasketballTEAMS" runat="server" AutoPostBack="True" 
        ...
        style="z-index: 1; left: 72px; position: absolute; width: 189px; top: 373px" 
        Visible="False">
    </asp:DropDownList>
    <asp:DropDownList ID="ddlIndividualStudentAttendance" runat="server" 
        AutoPostBack="True" BackColor="#FFD200" CausesValidation="True" 
        style="z-index: 1; left: 244px; top: 228px; position: absolute; width: 189px; right: 500px;" 
        Visible="False" 
    ...
    <asp:Label ID="lblIndividualStudent" runat="server" Font-Size="Large" 
        style="z-index: 1; left: 132px; top: 209px; position: absolute; width: 323px; font-weight: 700; height: 44px" 
        Text="Individual Volunteer Attendance.   (OPTIONAL)" Visible="False"></asp:Label>
    <asp:DropDownList ID="ddlOutreachBasketball" runat="server" AutoPostBack="True" 
        ...
        style="z-index: 1; left: 71px; top: 372px; position: absolute; width: 189px" 
        Visible="False">
    </asp:DropDownList>
    <asp:DropDownList ID="ddlBaseballSections" runat="server" AutoPostBack="True" 
        ...
        style="z-index: 1; left: 71px; top: 371px; position: absolute; width: 189px" 
        Visible="False">
    </asp:DropDownList>
    ...
    <asp:DropDownList ID="ddlTeamName" runat="server" AutoPostBack="True" 
        ...
        style="z-index: 1; left: 243px; top: 274px; position: absolute; width: 189px" 
        Visible="False">
    </asp:DropDownList>
    ...
    <asp:DropDownList ID="ddlMealsYesNo" runat="server" AutoPostBack="True" 
        ...
        style="z-index: 1; left: 272px; top: 310px; position: absolute; width: 68px" 
        Visible="False">
    </asp:DropDownList>
    <asp:DropDownList ID="ddlMealCount" runat="server" AutoPostBack="True" 
        BackColor="#FFD200" CausesValidation="True" 
        onselectedindexchanged="ddlMealCount_SelectedIndexChanged" 
        style="z-index: 1; left: 479px; top: 311px; position: absolute; width: 53px" 
        Visible="False" Enabled="False">
    </asp:DropDownList>
    <asp:Label ID="lblMealsServed" runat="server" 
        style="z-index: 1; left: 61px; top: 310px; position: absolute; height: 24px; width: 370px; font-weight: 700" 
        Text="Meals served at your activity?" Visible="False"></asp:Label>
    <asp:Label ID="lblHowMany" runat="server" 
        style="z-index: 1; left: 362px; top: 312px; position: absolute; width: 133px; font-weight: 700" 
        Text="# of meal times?" Visible="False"></asp:Label>




    <asp:Label ID="lblTeamName" runat="server" Font-Bold="True" Font-Size="Large" 
        style="z-index: 1; left: 131px; top: 255px; position: absolute; width: 315px; height: 42px" 
    ...
    <asp:Label ID="lblErrorMessage" runat="server" BackColor="White" 
        ...
        ForeColor="Red" 
        style="z-index: 1; left: 123px; top: 282px; position: absolute; height: 306px; width: 498px" 
