...
{
    public partial class EducationProgramSectionMaintenance : System.Web.UI.Page
    {
        ...
        public void bind()  
        {
            try
            {
                ...
                {
                    sql_LoadGrid = "select SectionName, meettime as 'Time', meetday as 'Day', location as 'Location', comments as 'Comments', StaffLeader as 'Instructor', devotionalleader as 'DevotionalLeader', id as 'id' "
                                 + "FROM AcademicReadingSupportProgramSections  order by sectionname";
                }
                ...
                {
                    da.Fill(ds, "AcademicReadingSupportProgramSections");
                }
        ...
        protected void RemoveFromTable(object sender, GridViewDeleteEventArgs e, string ID)
        {
            ...
            try
            {
                ...
                {
                    sql_DeleteFromClass1 = "Delete from UIF_PerformingArts.dbo.AcademicReadingSupportProgramSections "
                                         + "WHERE id = '" + ID + "' ";
                }
        ...
        protected void gvStudentList_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                cmd = new SqlCommand("Update [AcademicReadingSupportProgramSections] set "
                                     + "  staffleader='" + staffleader.Text
                                     + "' , devotionalleader='" + devotionalleader.Text
                                     + "' , sectionname='" + sectionname.Text
                                     + "' , meettime='" + meettime.Text
        ...
        protected void gvTeamSections_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                cmd = new SqlCommand("Update AcademicReadingSupportTeamNameSections set "
                                     + "  supervisor='" + supervisor.Text
                                     + "' , devotionalleader='" + devotionalleader.Text
                                     + "' , teamname='" + teamname.Text
                                     + "' , meettime='" + meettime.Text
            ...
            {
                cmd = new SqlCommand("Update SummerDayCampTeamNameSections set "
                                     + "  supervisor='" + supervisor.Text
                                     + "' , devotionalleader='" + devotionalleader.Text
                                     + "' , teamname='" + teamname.Text
                                     + "' , meettime='" + meettime.Text
        ...
        protected void ddlProgram_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    da.Fill(ds, "Impact Urban Schools");
                }
                //else if (ddlProgram.Text == "Singers")
                //{
                //    da.Fill(ds, "SingersProgramSections");
            ...
            if (ddlProgram.Text != "Please select a program")
            {
                if (ddlProgram.Text == "SummerDay Camp")
                {
                    ...
                    string sql = "Select sectionname "
                               + "from UIF_PerformingArts.dbo.SummerDayCampProgramSections "
                    ...
                    custDA.Fill(custDS, "SummerDayCampProgramSections");
                    ...
                    foreach (DataRow myDataRowPO in custDS.Tables["SummerDayCampProgramSections"].Rows)
                    {
                ...
                else if (ddlProgram.Text == "Academic Reading Support")
                {
                    //Load the dropdown list for the sections.
                    string sql = "Select sectionname "
                               + "from UIF_PerformingArts.dbo.AcademicReadingSupportProgramSections "
                               + "group by sectionname "
                               + "order by sectionname ";
                    ...
                    custDA.SelectCommand = cmd;
                    DataSet custDS = new DataSet();
                    custDA.Fill(custDS, "AcademicReadingSupportProgramSections");

                    ddlTeamNames.Items.Clear();
                    ddlTeamNames.Items.Add("Please select a Section");
                    //Iterate over setup records and call method to do the work on each one...RCM..
                    foreach (DataRow myDataRowPO in custDS.Tables["AcademicReadingSupportProgramSections"].Rows)
                    {
                        //Adding options to the drop downs for a new entry.
                        ddlTeamNames.Items.Add(myDataRowPO[0].ToString());
                    }
            ...
            if (ddlProgram.Text != "Please select a program")
            {
                if (ddlProgram.Text == "SummerDay Camp")
                {
                    ...
                    string sql = "Select teamname "
                               + "from UIF_PerformingArts.dbo.SummerDayCampTeamNameSections "
                               + "group by teamname "
                               + "order by teamname ";
                    ...
                    custDA.SelectCommand = cmd;
                    DataSet custDS = new DataSet();
                    custDA.Fill(custDS, "SummerDayCampTeamNameSections");

                    ddlTeamNames.Items.Clear();
                    ddlTeamNames.Items.Add("Please select a Section");
                    //Iterate over setup records and call method to do the work on each one...RCM..
                    foreach (DataRow myDataRowPO in custDS.Tables["SummerDayCampTeamNameSections"].Rows)
                    {
                        //Adding options to the drop downs for a new entry.
                        ddlTeamNames.Items.Add(myDataRowPO[0].ToString());
                    }
                ...
                else if (ddlProgram.Text == "Academic Reading Support")
                {
                    //Load the dropdown list for the sections.
                    string sql = "Select teamname "
                               + "from UIF_PerformingArts.dbo.AcademicReadingSupportTeamNameSections "
                               + "group by teamname "
                               + "order by teamname ";
                    ...
                    custDA.SelectCommand = cmd;
                    DataSet custDS = new DataSet();
                    custDA.Fill(custDS, "AcademicReadingSupportTeamNameSections");

                    ddlTeamNames.Items.Clear();
                    ddlTeamNames.Items.Add("Please select a Section");
                    //Iterate over setup records and call method to do the work on each one...RCM..
                    foreach (DataRow myDataRowPO in custDS.Tables["AcademicReadingSupportTeamNameSections"].Rows)
                    {
                        //Adding options to the drop downs for a new entry.
                        ddlTeamNames.Items.Add(myDataRowPO[0].ToString());
                    }
        ...
        protected void cmbAddRecord_Click(object sender, EventArgs e)
        {
            ...
            if ((ddlTeamNames.Text != "Please select a Section") && (ddlTeamNames.Visible))
            {
                ...
                try
                {
                    ...
                    if (ddlProgram.Text == "SummerDay Camp")
                    {
                        sqlInsertStatement = "INSERT into UIF_PerformingArts.dbo.SummerDayCampTeamNameSections " +
                            "values ( "
                    ...
                    {
                        sqlInsertStatement = "INSERT into UIF_PerformingArts.dbo.AcademicReadingSupportTeamNameSections " +
                            "values ( "
                            + "'" + txbClassName.Text.Trim() + "',"
                            + "'" + txbTeamName.Text.Trim() + "', "
                            + "'" + ddlTime.Text.Trim() + "',"
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (ddlProgram.Text == "SummerDay Camp")
                    {
                        sqlInsertStatement = "INSERT into UIF_PerformingArts.dbo.SummerDayCampProgramSections " +
                            "values ( "
                            + "'" + txbClassName.Text.Trim() + "', "
                            + "'" + ddlTime.Text.Trim() + "', "
                            + "'" + txbDay.Text.Trim() + "', "
                    ...
                    {
                        sqlInsertStatement = "INSERT into UIF_PerformingArts.dbo.AcademicReadingSupportProgramSections " +
                            "values ( "
                            + "'" + txbClassName.Text.Trim() + "',"
                            + "'" + ddlTime.Text.Trim() + "',"
                            + "'" + txbDay.Text.Trim() + "',"
