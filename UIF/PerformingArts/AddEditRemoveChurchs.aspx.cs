...
{
    public partial class AddEditRemoveChurchs : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["security"] == "Good")
                {
                    ...
                    try
                    {
                        sql_LoadGrid = "select Church, Neighborhood, NeighborhoodRegion, ZipCode, id as 'id' "
                                     + "FROM ChurchNames  "
                                     + "GROUP BY Church, Neighborhood, Neighborhoodregion, Zipcode, id "
                                     + "ORDER by Church";
        ...
        protected void gvStudentList_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow && row.RowIndex == irowNum)
            {
                ...
                string Church = drv.Row.ItemArray.GetValue(0).ToString();
        ...
        protected void RemoveFromTable(object sender, GridViewDeleteEventArgs e, string ID)
        {
            ...
            try
            {
                sql_DeleteFromClass1 = "Delete from UIF_PerformingArts.dbo.ChurchNames "
                                     + "WHERE id = '" + ID + "' ";
        ...
        protected void gvStudentList_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            TextBox Church = (TextBox)row.FindControl("textbox1");
            ...
            Church.Text = Church.Text.Replace("'", "");
            ...
            try
            {
                ...
                cmd = new SqlCommand("Update ChurchNames set "
                                    + "  Church='" + Church.Text
        ...
        protected void cmbAddRecord_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                sqlInsertStatement = "INSERT into UIF_PerformingArts.dbo.ChurchNames " +
                    "values ( "
        ...
        protected void cmbLoadData_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                selectSQL = "select church, neighborhood, neighborhoodregion, zipcode, syscreate, sysupdate, ID " +
                            "from UIF_PerformingArts.dbo.churchnames " +
                            "group by church, neighborhood, neighborhoodregion, zipcode, syscreate, sysupdate, ID " +
                            "order by church ";
                ...
                {	//Retrieve the first record only
                    ...
                    do
                    {
                        ...
                        {
                            sqlInsertStatement = "";
                            sqlInsertStatement = "INSERT into UIF_PerformingArts.dbo.ChurchNames2 " +
                                "values ( "
                                + "'" + txbClassName.Text.Trim() + "',"
                                + "'" + txbClassLocation.Text.Trim() + "', "
                                + "'" + txbInstructor.Text.Trim() + "', "
