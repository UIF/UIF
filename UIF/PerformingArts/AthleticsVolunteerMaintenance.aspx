<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AthleticsVolunteerMaintenance.aspx.cs" Inherits="UIF.PerformingArts.AthleticsVolunteerMaintenance" %>
...
<body bgcolor="#ff9900">
    ...
    <p>
        <asp:Label ID="Label3" runat="server" CssClass="style12" Font-Size="XX-Large" 
            Text="Athletics Volunteer Maintenance"></asp:Label>
    </p>
    <p>
        &nbsp;</p>
    ...
    <p>
        ...
        <asp:DropDownList ID="ddlTeamSectionUpdate" runat="server" BackColor="#FFD200" 
            style="z-index: 1; left: 696px; top: 266px; position: absolute; width: 188px; right: 376px;" 
            Visible="False" 
    ...
    <p>
        ...
        <asp:CheckBox ID="chbGotPicture" runat="server" 
            style="z-index: 1; left: 461px; top: 278px; position: absolute; width: 107px" 
        ...
        <asp:Label ID="lblStudentNames" runat="server" Font-Size="10pt" 
            ...
            Text="Volunteers" Visible="False"></asp:Label>
    </p>
    <asp:Button ID="cmbCallingListReport" runat="server" 
        onclick="cmbCallingListReport_Click" 
        style="z-index: 1; left: 1121px; top: 267px; position: absolute; height: 35px; width: 138px" 
        Text="Credential Report" Enabled="False" />
    <p>
        ...
        <asp:Button ID="cmbReport" runat="server" onclick="cmbReport_Click" 
            style="z-index: 1; left: 1121px; top: 199px; position: absolute; height: 35px; width: 138px; bottom: 279px; right: 35px;" 
        ...
        <asp:Button ID="cmbReset" runat="server" onclick="cmbReset_Click" 
            style="z-index: 1; left: 1121px; top: 162px; position: absolute; height: 33px; width: 138px" 
            Text="Reset Page" />
        <asp:Button ID="cmbUpdate" runat="server" onclick="cmbUpdate_Click" 
            style="z-index: 1; left: 506px; top: 325px; position: absolute; height: 53px; width: 138px" 
    ...
    <p>
        ...
        <asp:Label ID="lblName2" runat="server" 
            style="z-index: 1; left: 45px; top: 697px; position: absolute; height: 22px; width: 201px" 
            Text="Label" Visible="False"></asp:Label>
        <asp:Button ID="cmbExcelExport" runat="server" Enabled="False" 
            onclick="cmbExcelExport_Click" 
            style="z-index: 1; left: 1121px; top: 305px; position: absolute; height: 36px; width: 138px" 
            Text="Excel Export" />
    ...
    <p>
        <asp:DropDownList ID="ddlStudents" runat="server" AutoPostBack="True" 
            ...
            style="z-index: 1; left: 246px; top: 323px; position: absolute; width: 193px" 
            Visible="False">
        </asp:DropDownList>

        <asp:LinkButton ID="lbVolunteerHistory" runat="server" 
            onclick="lbAttendanceHistory_Click" 
            
            style="z-index: 1; left: 1109px; top: 243px; position: absolute; width: 218px">Volunteer Attendance History</asp:LinkButton>
    </p>
    <p>
    ...
    <p>
        <asp:Label ID="lblSPNotes" runat="server" Font-Size="10pt" 
            ...
            Text="Volunteer Profile Notes" Visible="False"></asp:Label>
