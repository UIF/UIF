<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEditRemoveSchools.aspx.cs" Inherits="UIF.PerformingArts.AddEditRemoveSchools" %>
...
<body bgcolor="Orange" >
    ...
    <asp:GridView ID="gvStudentList" runat="server" AllowSorting="True" 
        ...
        <Columns >  
            ...
            <ItemTemplate><%#Eval("school") %></ItemTemplate>  
            <EditItemTemplate><asp:TextBox ID="textbox1" runat="server" Text='<%#Eval("school") %>'></asp:TextBox></EditItemTemplate>
            </asp:TemplateField>  
    ...
    <asp:Label ID="lblClassName" runat="server" 
        ...
        Text="School Name" Visible="False"></asp:Label>
    ...
    <asp:Label ID="lblMainpage" runat="server" Font-Size="23pt" 
        ...
        Text="(Add/Edit/Remove)      School Names" Font-Italic="True"></asp:Label>
    ...
    <asp:Button ID="cmbLoadData" runat="server" onclick="cmbLoadData_Click" 
        style="z-index: 1; left: 494px; top: 185px; position: absolute" Text="LoadData" 
        Visible="False" />
    </form>
</body>
</html>
