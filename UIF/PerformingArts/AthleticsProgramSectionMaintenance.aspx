<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation ="false" CodeBehind="AthleticsProgramSectionMaintenance.aspx.cs" Inherits="UIF.PerformingArts.AthleticsProgramSectionMaintenance" %>
...
<body bgcolor="Orange" >
    ...
    <asp:Label ID="lblMainpage" runat="server" Font-Size="22pt" 
        style="z-index: 1; left: 425px; top: 151px; position: absolute; height: 36px; width: 493px; text-decoration: underline" 
        Text="Athletics Program Section Maintenance"></asp:Label>
