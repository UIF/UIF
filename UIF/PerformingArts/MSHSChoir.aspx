<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MSHSChoir.aspx.cs" Inherits="UIF.PerformingArts.MSHSChoir" %>
...
<body bgcolor="Orange">
    ...
    <asp:Label ID="lblMSHSChoir" runat="server" EnableViewState="False" 
        ...
        style="z-index: 1; left: 357px; top: 147px; position: absolute; height: 42px; width: 528px; text-decoration: underline" 
        Text="Middle/High School Choir Maintenance"></asp:Label>
    ...
    <asp:Button ID="cmbEmergencyContact" runat="server" 
        ...
        style="z-index: 1; left: 968px; top: 210px; position: absolute; height: 36px; width: 196px" 
        Text="Emergency Information" />
    <asp:Button ID="cmbHealthConditions" runat="server" 
        onclick="cmbHealthConditions_Click" 
        style="z-index: 1; left: 949px; top: 252px; position: absolute; height: 34px; width: 215px" 
