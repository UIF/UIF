<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChildrensChoir.aspx.cs" Inherits="UIF.PerformingArts.ChildrensChoir" %>
...
<body bgcolor="Orange">
    ...
    <asp:Label ID="lblChildrensChoir" runat="server" Font-Bold="False" 
        Font-Size="25pt" 
        style="z-index: 1; left: 398px; top: 151px; position: absolute; height: 49px; width: 453px; text-decoration: underline" 
        Text="Childrens Choir Maintenance"></asp:Label>
