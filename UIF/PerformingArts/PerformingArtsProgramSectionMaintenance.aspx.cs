...
{
    public partial class PerformingArtsProgramSectionMaintenance : System.Web.UI.Page
    {
        ...
        protected void gvTeamSections_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                cmd = new SqlCommand("Update MSHSChoirTEAMNameSections set "
                                     + " teamname='" + teamname.Text
                                     + "' , supervisor='" + supervisor.Text
                                     + "' , devotionalleader='" + devotionalleader.Text
                                     + "' , sectionname='" + sectionname.Text
            ...
            {
                cmd = new SqlCommand("Update [ChildrensChoirTEAMNameSections] set "
                                     + " teamname='" + teamname.Text
                                     + "' , supervisor='" + supervisor.Text
                                     + "' , devotionalleader='" + devotionalleader.Text
                                     + "' , sectionname='" + sectionname.Text
            ...
            {
                cmd = new SqlCommand("Update [PerformingArtsAcademyTEAMNameSections] set "
                                     + " teamname='" + teamname.Text
                                     + "' , supervisor='" + supervisor.Text
                                     + "' , devotionalleader='" + devotionalleader.Text
                                     + "' , sectionname='" + sectionname.Text
            ...
            {
                cmd = new SqlCommand("Update [ShakesTEAMNameSections] set "
                                     + " teamname='" + teamname.Text
                                     + "' , supervisor='" + supervisor.Text
                                     + "' , devotionalleader='" + devotionalleader.Text
                                     + "' , sectionname='" + sectionname.Text
            ...
            {
                cmd = new SqlCommand("Update [SingersTEAMNameSections] set "
                                     + " teamname='" + teamname.Text
                                     + "' , supervisor='" + supervisor.Text
                                     + "' , devotionalleader='" + devotionalleader.Text
                                     + "' , sectionname='" + sectionname.Text
            ...
            if (ddlProgram.Text != "Please select a program")
            {
                if (ddlProgram.Text == "MSHS Choir")
                {
                    ...
                    string sql = "Select teamname "
                               + "from UIF_PerformingArts.dbo.MSHSChoirTEAMNameSections "
                               + "group by teamname "
                               + "order by teamname ";
                    ...
                    custDA.SelectCommand = cmd;
                    DataSet custDS = new DataSet();
                    custDA.Fill(custDS, "MSHSChoirTEAMNameSections");

                    ddlTeamNames.Items.Clear();
                    ddlTeamNames.Items.Add("Please select a Section");
                    //Iterate over setup records and call method to do the work on each one...RCM..
                    foreach (DataRow myDataRowPO in custDS.Tables["MSHSChoirTEAMNameSections"].Rows)
                    {
                        //Adding options to the drop downs for a new entry.
                        ddlTeamNames.Items.Add(myDataRowPO[0].ToString());
                    }
                ...
                else if (ddlProgram.Text == "Childrens Choir")
                {
                    //Load the dropdown list for the sections.
                    string sql = "Select teamname "
                               + "from UIF_PerformingArts.dbo.ChildrensChoirTEAMNameSections "
                               + "group by teamname "
                               + "order by teamname ";
                    ...
                    custDA.SelectCommand = cmd;
                    DataSet custDS = new DataSet();
                    custDA.Fill(custDS, "ChildrensChoirTEAMNameSections");

                    ddlTeamNames.Items.Clear();
                    ddlTeamNames.Items.Add("Please select a Section");
                    //Iterate over setup records and call method to do the work on each one...RCM..
                    foreach (DataRow myDataRowPO in custDS.Tables["ChildrensChoirTEAMNameSections"].Rows)
                    {
                        //Adding options to the drop downs for a new entry.
                        ddlTeamNames.Items.Add(myDataRowPO[0].ToString());
                    }
                ...
                else if (ddlProgram.Text == "PerformingArtsAcademy")
                {
                    //Load the dropdown list for the sections.
                    string sql = "Select teamname "
                               + "from UIF_PerformingArts.dbo.PerformingArtsAcademyTEAMNameSections "
                               + "group by teamname "
                               + "order by teamname ";
                    ...
                    custDA.SelectCommand = cmd;
                    DataSet custDS = new DataSet();
                    custDA.Fill(custDS, "PerformingArtsAcademyTEAMNameSections");

                    ddlTeamNames.Items.Clear();
                    ddlTeamNames.Items.Add("Please select a Section");
                    //Iterate over setup records and call method to do the work on each one...RCM..
                    foreach (DataRow myDataRowPO in custDS.Tables["PerformingArtsAcademyTEAMNameSections"].Rows)
                    {
                        //Adding options to the drop downs for a new entry.
                        ddlTeamNames.Items.Add(myDataRowPO[0].ToString());
                    }
                ...
                else if (ddlProgram.Text == "Singers")
                {
                    //Load the dropdown list for the sections.
                    string sql = "Select teamname "
                               + "from UIF_PerformingArts.dbo.SingersTEAMNameSections "
                               + "group by teamname "
                               + "order by teamname ";
                    ...
                    custDA.SelectCommand = cmd;
                    DataSet custDS = new DataSet();
                    custDA.Fill(custDS, "SingersTEAMNameSections");

                    ddlTeamNames.Items.Clear();
                    ddlTeamNames.Items.Add("Please select a Section");
                    //Iterate over setup records and call method to do the work on each one...RCM..
                    foreach (DataRow myDataRowPO in custDS.Tables["SingersTEAMNameSections"].Rows)
                    {
                        //Adding options to the drop downs for a new entry.
                        ddlTeamNames.Items.Add(myDataRowPO[0].ToString());
                    }
                ...
                else if (ddlProgram.Text == "Shakes")
                {
                    //Load the dropdown list for the sections.
                    string sql = "Select teamname "
                               + "from UIF_PerformingArts.dbo.ShakesTEAMNameSections "
                               + "group by teamname "
                               + "order by teamname ";
                    ...
                    custDA.SelectCommand = cmd;
                    DataSet custDS = new DataSet();
                    custDA.Fill(custDS, "ShakesTEAMNameSections");

                    ddlTeamNames.Items.Clear();
                    ddlTeamNames.Items.Add("Please select a Section");
                    //Iterate over setup records and call method to do the work on each one...RCM..
                    foreach (DataRow myDataRowPO in custDS.Tables["ShakesTEAMNameSections"].Rows)
                    {
                        //Adding options to the drop downs for a new entry.
                        ddlTeamNames.Items.Add(myDataRowPO[0].ToString());
                    }
